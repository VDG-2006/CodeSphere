/**
 * config.js — CodeSphere Runtime Configuration
 *
 * ⚠️  This file is listed in .gitignore and must NEVER be committed.
 *     Copy config.example.js, rename it to config.js, and fill in
 *     your real Firebase credentials from the Firebase Console.
 */
